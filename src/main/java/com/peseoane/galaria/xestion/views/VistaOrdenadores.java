...
@Entity
@Immutable
@Table(name = "vista_ordenadores", schema = "inventario")
public class VistaOrdenadores {
    @Id
    ...
    @Nationalized
    @Column(name = "\"IP Primaria\"", length = 15)
    private String iPPrimaria;
    ...
    @Nationalized
    @Column(name = "\"Sistema Operativo\"", nullable = false, length = 129)
